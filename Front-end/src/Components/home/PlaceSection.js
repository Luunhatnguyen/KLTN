...
import animicon1 from "../../image/icon/anim-icon-1.png";
import shape3 from "../../image/shape/shape-3.png";
import place1 from "../../image/place/place-1.jpg";
import place2 from "../../image/place/place-2.jpg";
import place3 from "../../image/place/place-3.jpg";
import place4 from "../../image/place/place-4.jpg";
      ...
      <div className="auto-container">
        <div className="row clearfix">
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 place-block">
            <div className="place-block-one">
              <div
                className="inner-box wow fadeInUp animated animated"
                data-wow-delay="00ms"
                data-wow-duration="1500ms"
              >
                <figure className="image-box">
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 link-column">
            <div
              className="link-box centred wow fadeInRight animated animated"
              data-wow-delay="00ms"
              data-wow-duration="1500ms"
            >
              <h3>
