        ...
        <>
          <div className="user-img">
            <Link className="img-user text-success" to="/">
              <img className="avt" src={user.avatar} alt="avatar" />
              user admin
            </Link>
          </div>
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              ...
              <Link className="nav-link text-success" to="/admin">
                Trang Admin
              </Link>
              {/* <Link className="nav-link text-success" to="/show">Tours</Link> */}
              <Link className="nav-link text-success" to="/addArtical">
                Quản lý trang tin tức{" "}
              </Link>
              <Link className="nav-link text-success" to="/deleteTour">
                Quản lý trang chuyến đi{" "}
              </Link>
            </Nav>
            <NavItem>
